...
public class FlinkCostKafkaBoy {
    ...
    public static void main(String[] args) throws Exception {
        ...
        properties.setProperty("group.id", "flink-boys");

        FlinkKafkaConsumer08<String> myConsumer = new FlinkKafkaConsumer08<String>("flink-boys", new SimpleStringSchema(),
                properties);
    ...
    public static final class YouthSplitter implements FlatMapFunction<String, Tuple3<String,String,Integer>> {
        ...
        public void flatMap(String value, Collector<Tuple3<String,String, Integer>> out) {
                    out.collect(new Tuple3<String,String, Integer>("boy","youth",1));
        }
    }
    ...
    public static final class OldSplitter implements FlatMapFunction<String, Tuple3<String,String,Integer>> {
        ...
        public void flatMap(String value, Collector<Tuple3<String,String, Integer>> out) {
            out.collect(new Tuple3<String,String, Integer>("boy","old",1));
        }
    }
}